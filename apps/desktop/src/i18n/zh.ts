...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: '正在加载 奇计 设置',
      loadingSessions: '正在加载最近会话',
      startingDesktopConnection: '正在启动桌面连接',
      starting奇计Desktop: '正在启动 奇计 桌面版…'
    },
    errors: {
      backgroundExited: '奇计 后台进程已退出。',
      backgroundExitedDuringStartup: '奇计 后台进程在启动期间退出。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '你的 奇计 后端早于当前桌面构建，可能无法正常工作。请更新以保持一致。',
    update奇计: '更新 奇计',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 奇计 Desktop。',
    ...
    native: {
      ...
      rejectAction: '拒绝',
      inputTitle: '需要输入',
      inputBody: '奇计 正在等待你的回应。',
      turnDoneTitle: '奇计 已完成',
      turnDoneBody: '回复已就绪。',
      turnErrorTitle: '本轮失败',
  ...
  settings: {
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: '需要输入',
          description: '奇计 提出了问题，或需要密码或密钥。'
        },
        turnDone: {
          label: '回复就绪',
          description: '奇计 在后台时完成了一轮对话。'
        },
        turnError: {
          label: '本轮失败',
          description: '本轮以错误结束。'
    ...
    appearance: {
      ...
      colorMode: '颜色模式',
      colorModeDesc: '选择固定模式，或让 奇计 跟随系统设置。',
      ...
      pet: {
        title: '宠物',
        intro: '领养一只悬浮在应用上的 petdex 动画宠物，它会根据 奇计 的状态做出反应——工具执行时奔跑、成功时欢呼、出错时沮丧。',
        restartHint: '宠物功能需要重启——当前运行的应用在此功能加入前启动。请退出并重新打开 奇计，然后回到此处。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: '当 奇计 需要本地时间上下文时使用。留空则使用系统时区。',
      agent: {
        imageInputMode: '控制图片附件如何发送给模型。',
        maxTurns: '奇计 停止一次运行前工具调用轮次的上限。'
      },
      terminal: {
        cwd: '工具与终端操作的默认项目目录。',
      ...
      fileReadMaxChars: '奇计 单次文件读取可读取的最大字符数。',
      approvals: {
        mode: '奇计 如何处理需要显式审批的命令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          '奇计 从应用内更新时（无终端提示），保留本地源码修改（暂存）或丢弃（放弃）。通过终端更新时始终会询问。'
      }
    }),
    about: {
      heading: '奇计 Desktop',
      ...
      automaticUpdatesDesc: '奇计 会在后台自动检查更新，并在有可用更新时通知你。',
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        '奇计 Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 奇计 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      localTitle: '本地网关',
      localDesc: '在 localhost 启动私有 奇计 后端。这是默认方式，并且可离线工作。',
      remoteTitle: '远程网关',
      remoteDesc:
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: '奇计 Desktop 将使用已保存设置重新连接。',
      savedMessage: '已保存，下一次重启生效。',
      connectedTo: (baseUrl, version) => `已连接到 ${baseUrl}${version ? ` · 奇计 ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: '使用订阅登录，无需复制 API 密钥。奇计 会在应用中为你完成浏览器登录。',
      connected: '已连接',
      collapse: '收起',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '请重启 奇计 以使用宠物功能——当前后端版本过旧。',
      empty: '没有匹配的宠物。',
      turnOff: '关闭',
      turnOn: '开启',
      installed: '已安装',
    ...
    nav: {
      ...
      settings: { title: '设置', detail: '配置 奇计 桌面端' },
    ...
    hermesActiveSessions: (version, count) => `奇计 ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 用户 ID', placeholder: '@qiji:example.org' },
      ...
      // ---- 钉钉 ----
      DINGTALK_CLIENT_ID: { label: '钉钉 Client ID', help: '钉钉应用的 App Key（Client ID），在钉钉开放平台获取。', placeholder: '粘贴 Client ID' },
      DINGTALK_CLIENT_SECRET: { label: '钉钉 Client Secret', help: '钉钉应用的 App Secret（Client Secret），在钉钉开放平台获取。', placeholder: '粘贴 Client Secret' },
      DINGTALK_WEBHOOK_URL: { label: '钉钉机器人 Webhook（可选）', help: '用于跨平台/cron 投递的静态机器人 webhook URL。' },
      DINGTALK_ALLOWED_USERS: { label: '允许的用户', help: '逗号分隔的员工/发送者 ID，允许与机器人对话（* 表示所有人）。' },
      DINGTALK_HOME_CHANNEL: { label: '主页会话 ID', help: 'cron/通知投递的默认会话 ID。' },
      DINGTALK_HOME_CHANNEL_NAME: { label: '主页会话显示名称', help: '钉钉主页会话的显示名称。' },
      // ---- 飞书 / Lark ----
      FEISHU_APP_ID: { label: '飞书 App ID', help: '飞书/Lark 应用的 App ID。' },
      FEISHU_APP_SECRET: { label: '飞书 App Secret', help: '飞书/Lark 应用的 App Secret。', placeholder: '粘贴 App Secret' },
      FEISHU_ENCRYPT_KEY: { label: '飞书加密密钥', help: '飞书/Lark 事件的加密密钥。', placeholder: '粘贴加密密钥' },
      FEISHU_VERIFICATION_TOKEN: { label: '飞书验证 Token', help: '飞书/Lark 事件的验证 Token。', placeholder: '粘贴验证 Token' },
      FEISHU_DOMAIN: { label: '飞书域名', help: '飞书 API 域名（国内默认 open.feishu.cn，国际版用 open.larksuite.com）。' },
      FEISHU_ALLOWED_USERS: { label: '允许的飞书用户', help: '逗号分隔的飞书用户 ID（* 表示所有人）。' },
      FEISHU_ALLOW_ALL_USERS: { label: '允许所有飞书用户', help: '为 true 时跳过允许列表，任何人都可以与机器人对话。' },
      FEISHU_HOME_CHANNEL: { label: '飞书主页会话 ID', help: 'cron/通知投递的默认会话 ID。' },
      FEISHU_HOME_CHANNEL_NAME: { label: '飞书主页会话名称', help: '飞书主页会话的显示名称。' },
      // ---- 企业微信（群机器人）----
      WECOM_BOT_ID: { label: '企业微信机器人 ID', help: '群机器人的 webhook key。' },
      WECOM_SECRET: { label: '企业微信 Secret', help: '企业微信应用的 Secret。', placeholder: '粘贴 Secret' },
      WECOM_ALLOWED_USERS: { label: '允许的企业微信用户', help: '逗号分隔的企业微信用户 ID（* 表示所有人）。' },
      WECOM_HOME_CHANNEL: { label: '企业微信主页会话', help: 'cron/通知投递的默认会话。' },
      WECOM_HOME_CHANNEL_NAME: { label: '企业微信主页会话名称' },
      WECOM_WEBSOCKET_URL: { label: '企业微信 WebSocket URL', help: '企业微信回调的 WebSocket 连接 URL（高级）。' },
      // ---- 企业微信（自建应用回调）----
      WECOM_CALLBACK_CORP_ID: { label: '企业微信 Corp ID', help: '企业微信企业的 Corp ID。' },
      WECOM_CALLBACK_CORP_SECRET: { label: '企业微信 Corp Secret', help: '企业微信应用的 Corp Secret。', placeholder: '粘贴 Corp Secret' },
      WECOM_CALLBACK_AGENT_ID: { label: '企业微信 Agent ID', help: '企业微信自建应用的 Agent ID。' },
      WECOM_CALLBACK_TOKEN: { label: '企业微信回调 Token', help: '企业微信回调 URL 的验证 Token。' },
      WECOM_CALLBACK_ENCODING_AES_KEY: { label: '企业微信回调 AES 密钥', help: '企业微信回调的 EncodingAESKey。' },
      WECOM_CALLBACK_HOST: { label: '企业微信回调主机', help: '企业微信回调服务器监听的主机地址（高级）。' },
      WECOM_CALLBACK_PORT: { label: '企业微信回调端口', help: '企业微信回调服务器监听的端口（高级）。' },
      // ---- QQ 机器人 ----
      QQ_APP_ID: { label: 'QQ App ID', help: 'QQ 开放平台 (q.qq.com) 应用的 App ID。' },
      QQ_CLIENT_SECRET: { label: 'QQ Client Secret', help: 'QQ 开放平台应用的 Client Secret。', placeholder: '粘贴 Client Secret' },
      QQ_ALLOWED_USERS: { label: '允许的 QQ 用户', help: '逗号分隔的 QQ 用户 ID（* 表示所有人）。' },
      QQ_GROUP_ALLOWED_USERS: { label: '允许的 QQ 群', help: '逗号分隔的 QQ 群 ID（* 表示所有群）。' },
      QQ_HOME_CHANNEL: { label: 'QQ 主页频道', help: 'cron/通知投递的默认频道或群组。' },
      QQ_HOME_CHANNEL_NAME: { label: 'QQ 主页频道名称' },
      QQ_SANDBOX: { label: 'QQ 沙箱模式', help: '为 true 时启用沙箱环境（高级）。' },
    ...
    platformIntro: {
      ...
      signal: '在可访问的位置运行 signal-cli REST 桥接，然后把 奇计 指向该 URL 和已注册的电话号码。',
      whatsapp: '启动 奇计 自带的 WhatsApp 桥接，首次运行时扫描二维码，然后启用该平台。',
      bluebubbles:
        '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 奇计 指向该 URL。',
  ...
  profiles: {
    ...
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 奇计 环境：各自拥有独立的配置、技能和 SOUL.md。',
    nameLabel: '名称',
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
  ...
  cron: {
    ...
    newCron: '新建定时任务',
    emptyDescNew: '按 cron 表达式排程一个提示词。奇计 会运行它，并把结果发送到你选择的目的地。',
  ...
  composer: {
    ...
    attachUrlDesc: '奇计 将抓取该页面并作为本回合的上下文。',
  ...
  updates: {
    ...
    unsupportedMessage: '此版本的 奇计 无法在应用内自行更新。',
    connectionRetry: '请检查网络连接后重试。',
    latestBody: '你正在运行最新版本。',
    latestBodyBackend: '后端正在运行最新版本。',
    allSetTitle: '已是最新',
    availableTitle: '有可用更新',
    availableBody: '新版 奇计 已可安装。',
    availableTitleBackend: '后端有可用更新',
    availableBodyBackend: '已连接的 奇计 后端有新版本可安装。',
    availableBodyNoChangelog: '已有新版本可用。此安装方式无法显示更新日志。',
    updateNow: '立即更新',
    maybeLater: '稍后再说',
    moreChanges: count => `另有 ${count} 项更改。`,
    manualTitle: '从终端更新',
    manualBody: '你是从命令行安装的 奇计，因此更新也需要在那里运行。请将此命令粘贴到终端：',
    manualPickedUp: '下次启动 奇计 时会使用新版本。',
    guiSkewTitle: '请更新桌面应用',
    guiSkewBody: '后端已更新，但此桌面应用包未更改。请更新或重新安装 奇计 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: '奇计 更新器会在自己的窗口中接管，并在完成后自动重新打开 奇计。更新期间请不要自行重新打开 奇计。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 奇计 会自动重新连接。',
    applyingClose: '此窗口会在更新期间关闭，随后 奇计 会自动重新打开。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 奇计 Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 奇计 CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 奇计 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
    activeDesc: '这是一次性设置。奇计 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  onboarding: {
    headerTitle: '开始设置 奇计 Agent',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: '奇计 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 奇计…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自托管',
        description: '将 奇计 指向本地或自托管的 OpenAI 兼容端点 (vLLM、llama.cpp、Ollama 等)。'
      }
    },
    backToSignIn: '返回登录',
    getKey: '获取密钥',
    ...
    localBaseUrlLabel: '端点地址',
    localApiKeyLabel: 'API 密钥',
    couldNotSave: '无法保存凭据。',
    connecting: '连接中',
    update: '更新',
    flowSubtitles: {
      pkce: '打开浏览器登录，然后回到这里继续',
      device_code: '在浏览器中打开验证页面 — 奇计 会自动连接',
      loopback: '打开浏览器登录 — 奇计 会自动连接',
    ...
    authorizeThere: '请在那里授权 奇计。',
    copyAuthCode: '复制授权码并粘贴到下面。',
    pasteAuthCode: '粘贴授权码',
    reopenAuthPage: '重新打开授权页面',
    autoBrowser: provider => `已在浏览器中打开 ${provider}。请在那里授权 奇计，连接会自动完成，无需复制或粘贴。`,
  ...
  preview: {
    ...
    largeTitle: '此文件较大',
    largeBody: (label, size) => `${label} 大小为 ${size}。奇计 只会显示前 512 KB。`,
    previewAnyway: '仍然预览',
    ...
    web: {
      ...
      tryAgain: '重试',
      restarting: '奇计 正在重启...',
      askRestart: '让 奇计 重启服务器',
      lookingRestart: taskId => `奇计 正在查找要重启的预览服务器 (${taskId})`,
      restartingTitle: '正在重启预览服务器',
      restartingMessage: '奇计 正在后台工作。可在预览控制台查看进度。',
      ...
      finishedRestarting: message => `奇计 已完成预览服务器重启${message ? `: ${message}` : ''}`,
      failedRestarting: message => `服务器重启失败：${message}`,
      unknownError: '未知错误',
      restartedTitle: '预览服务器已重启',
      reloadingNow: '正在重新加载预览。',
      restartFailedTitle: '预览重启失败',
      restartFailedMessage: '奇计 无法重启服务器。',
      stillWorking: '奇计 仍在工作，但还没有收到重启结果。服务器命令可能正在前台运行。',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.hermes/config.yaml)。奇计 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: '奇计 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
    sudoPlaceholder: 'sudo 密码',
    secretTitle: '需要密钥',
    secretDesc: '奇计 需要一个凭据才能继续。',
  ...
  desktop: {
    ...
    editFailed: '编辑失败',
    resumeFailed: '恢复失败',
    resumeDeniedAccount: '该会话不属于当前登录账号，已阻止访问。',
    ...
    restartToUseSaveImage: '重启 奇计 桌面版后可使用保存图片。',
    restartToSaveImages: '重启 奇计 桌面版以保存图片',
