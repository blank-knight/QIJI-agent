...
export const en: Translations = {
  ...
  boot: {
    ready: '奇计 Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading 奇计 settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      starting奇计Desktop: 'Starting 奇计 Desktop…'
    },
    errors: {
      backgroundExited: '奇计 background process exited.',
      backgroundExitedDuringStartup: '奇计 background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your 奇计 backend is older than this desktop build and may not work correctly. Update to align them.',
    update奇计: 'Update 奇计',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting 奇计 Desktop.',
    ...
    native: {
      ...
      inputBody: '奇计 is waiting for your response.',
      turnDoneTitle: '奇计 finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to 奇计 defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while 奇计 is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: '奇计 asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while 奇计 was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let 奇计 follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what 奇计 is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen 奇计, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        '奇计 checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading 奇计 configuration...',
    ...
    gateway: {
      ...
      intro:
        '奇计 Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running 奇计 backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private 奇计 backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote 奇计 backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /qiji.',
      ...
      restartingMessage: '奇计 Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · 奇计 ${version}` : ''}`,
    ...
    model: {
      ...
      setUp: name => `Set up ${name}`,
      activate: 'Activate',
      activating: 'Activating...',
      pasteApiKey: name => `Paste ${name}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. 奇计 runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Qiji Cloud subscription — sign in at aicps.vip to activate.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart 奇计 to use pets — the backend predates this feature.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure 奇计 desktop' },
    ...
    hermesActiveSessions: (version, count) => `奇计 ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@qiji:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent 奇计 environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. 奇计 will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting 奇计...',
    placeholderReconnecting: 'Reconnecting to 奇计…',
    ...
    attachUrlDesc: '奇计 will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of 奇计 can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of 奇计 is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected 奇计 backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed 奇计 from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: '奇计 will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the 奇计 desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The 奇计 updater takes over in its own window and reopens 奇计 automatically when it’s done. Please don’t reopen 奇计 yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. 奇计 reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then 奇计 reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: '奇计 needs a one-time install',
    ...
    settingUpTitle: 'Setting up 奇计 Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another 奇计 CLI or desktop instance is running. Stop any running 奇计 instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The 奇计 installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with 奇计 Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: '奇计 is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting 奇计…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run 奇计 via aicps.vip',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point 奇计 at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    localBaseUrlLabel: 'Endpoint URL',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — 奇计 connects automatically',
      loopback: 'Opens your browser to sign in — 奇计 connects automatically',
    ...
    authorizeThere: 'Authorize 奇计 there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize 奇计 there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: '奇计 inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. 奇计 will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: '奇计 is restarting...',
      askRestart: 'Ask 奇计 to restart the server',
      lookingRestart: taskId => `奇计 is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: '奇计 is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `奇计 finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: '奇计 could not restart the server.',
      stillWorking:
        '奇计 is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: '奇计 is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: '奇计 gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). 奇计 won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: '奇计 needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: '奇计 needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart 奇计 Desktop to use Save Image.',
    restartToSaveImages: 'Restart 奇计 Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is the 奇计 gateway running?'
    }
  },
