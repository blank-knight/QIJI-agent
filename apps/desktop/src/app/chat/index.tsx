...
const INTRO_QUICK_SKILLS: QuickSkill[] = [
  { name: 'pptx-maker', title: '📄 PPT', desc: '生成/编辑演示文稿' },
  { name: 'xlsx-master', title: '📊 Excel', desc: '建表/公式/透视汇总' },
  { name: 'docx-writer', title: '📝 Word', desc: '报告/合同生成' },
  { name: 'whisper', title: '🎙️ 语音', desc: '录音/视频转文字稿' }
]
